	...
	<form method="get">
		<table class="bordered marginTop20 marginBottom20">
			<tr>
				<th>
				<a href="#">First Name</a> / 
					<a href="users?order=LastName&orderType=${ orderType }&search=${ search }">Last Name</a>
	
				</th>
				
				<th class="center-align">
					<a href="users?order=DateBirth&orderType=${ orderType }&search=${ search }">Date of Birth</a>
				</th>
			...
			<c:forEach var="user" items="${users}">
				<tr>
					<td>
						...
						<label for="du${ user.getId() }"><a href='<c:url value="/?action=details&id=${ user.getId() }"  />'>${ user.getFirstName() }
		...
		<div class="center-align">
			<a href="<c:url value="/?action=details" />"><div class="btn marginH10 orange">Add new user</div></a>
